...
const Footer = () => (<>
    <footer className={'flex flex-col sm:flex-row sm:justify-between prose container text-md py-3 mb-1 border-t border-gray-300 mt-4 text-gray-700 font-light'}>
        <p>
